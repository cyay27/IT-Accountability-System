...
interface IPadInventoryChartProps {
...
export const IPadInventoryChart = ({ records }: IPadInventoryChartProps) => {
  ...
  const chart = useMemo(() => {
    ...
    filteredRecords.forEach((item) => {
      const key = item.deviceCondition?.trim() || "Unspecified";
  ...
  return (
    <section className="panel">
      <div className="inventory-chart-header">
        <div>
          <h2>IPAD Chart</h2>
          <p className="helper-text">Distribution of iPad records by device condition.</p>
        </div>
      ...
      <div className="inventory-pie-layout">
        <div className="inventory-pie-wrap">
          <div
            ...
            aria-label="iPad inventory distribution by condition"
          />
